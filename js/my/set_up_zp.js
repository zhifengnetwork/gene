window.onload = function () {
   ...
   */
    ...
    */
    ...
    //下一步
    $(".revisePhone .nextBtn").click(function(){
        $(".revisePhone .reviseBtn").css("display","block");
        $(".revisePhone .nextBtn").hide();
        $(".revisePhone .newphoneNum").show();   
        $(".revisePhone .phoneNum").hide();
    })
    //修改
    $(".revisePhone .reviseBtn").click(function(){
        var phoneVal = $(".newphoneNum").val();
        $("#phoneVal").text(phoneVal);
        $(".revisePhone .newphoneNum").hide();   
        $(".revisePhone .phoneNum").show();
    })
    // 关闭
    $(".closeBtn,.revisePhone .reviseBtn,.mask").click(function(){
        $(".revisePhone .reviseBtn").hide();
        $(".revisePhone .nextBtn").css("display","block");
        $(".revisePhone .newphoneNum").hide();   
        $(".revisePhone .phoneNum").show();
    })
